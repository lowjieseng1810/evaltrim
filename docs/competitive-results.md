...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 01_basic_grading | common_subset_accuracy | 1; MEASURED; v1.0.0 | 1; MEASURED; v0.7.0 | 1; MEASURED; v0.122.0; echo provider; isolated Node 22.22.0 | 1; MEASURED; v4.2.0; ExactMatch+PatternMatch; GEval LLM-DEPENDENT | 1; MEASURED; v0.3.260; mockllm exact scorer | UNMEASURED | 1; MEASURED; v0.28.0-beta; ResponseAssertions | UNMEASURED | TIE | fixtures/grader_cases.yaml; in-process; 2026-08-25; 4×Xeon 15GiB; AgentEval 0.7.0 |
| 02_json_schema | accuracy_on_three_gold_cases | 1; MEASURED; v1.0.0 | 1; MEASURED; v0.7.0 | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | TIE | fixtures/grader_cases.yaml; in-process; 2026-08-25; 4×Xeon 15GiB; AgentEval 0.7.0; AgentEval uses jsonschema library |
...
| 13_redteam | local_probe_detection_rate | 1; MEASURED; v1.0.0 | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | evaltrim.security.evaluate_security; Promptfoo CLI not executed |
...
- C Evaluation Intelligence: **9.7959 / 10**
- Overall unweighted mean: **9.932 / 10**
- Weighted: `{'equal': 9.932, 'intelligence_heavier': 9.9183, 'eval_workflow_heavier': 9.9592}`
...
| --- | --- | --- | --- | --- |
| 100 | 6.0759 | 9.67 | 4950 | 1.0 |
| 500 | 12.1472 | 72.61 | 19856 | 1.0 |

Dedicated 10k process (`EVALTRIM_NO_CACHE=1`, same generator): **55.6263s**, peak **416.54 MiB**, 76205 pairs. Incremental 10k with 5 changed tests (pair cache on): **10.3646s** (75579 hits / 626 misses). Competitor scale cells remain UNMEASURED.
